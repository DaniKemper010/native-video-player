...
### Fixed
- **State Emission**: Fixed issue with state emission to ensure proper state updates across all listeners
  - Improved state synchronization for video player controllers
  - Enhanced reliability of state updates when controllers are initialized
  - Better handling of state changes during player lifecycle events
